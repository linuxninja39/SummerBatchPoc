...
namespace SummerBatchPoc
{
    /// <inheritdoc />
    /// <summary>
    /// Implements <see cref="T:Summer.Batch.Infrastructure.Item.IItemProcessor`2" /> for FlatFileRecord processing duty.
    /// </summary>
    public class FlatFileRecordProcessor : IItemProcessor<FlatFileRecord, FlatFileRecord>
    {
        ...
        /// <summary>
        /// Implements the business logic for FlatFileRecord processing;
        /// </summary>
        ...
        public FlatFileRecord Process(FlatFileRecord item)
        {
            ...
            if (item?.Name != null && item.Description != null && item.Name.Equals(item.Description))
            {
